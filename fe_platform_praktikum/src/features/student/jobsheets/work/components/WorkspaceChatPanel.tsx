...
export default function WorkspaceChatPanel({
  ...
  return (
    <div className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 z-50 flex w-[calc(100vw-2rem)] sm:w-[380px] md:w-[400px] h-[520px] max-h-[85vh] flex-col rounded-2xl border border-gray-200 bg-white shadow-2xl overflow-hidden transition-all duration-300 animate-in fade-in slide-in-from-bottom-4">
      {/* Popup Header */}
        ...
        {!loading && !error && messages.length === 0 && (
          <div className="flex h-full flex-col items-center justify-center text-center p-6 text-gray-400">
            ...
            <p className="text-[11px] text-gray-400 mt-1">
              Kirim pesan ke dosen pengampu jika ada kendala pengerjaan.
            </p>
          </div>
        )}
