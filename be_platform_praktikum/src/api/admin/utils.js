...
function handleAdminError(error, res) {
  ...
  const errors = {
    ...
    USER_HAS_CLASSES: [409, 'Dosen tidak dapat dihapus karena masih menjadi pengampu kelas.'],
    STUDENT_HAS_CLASSES: [409, 'Mahasiswa tidak dapat dihapus karena sudah terdaftar pada kelas mahasiswa.'],
    STUDENT_HAS_SUBMISSIONS: [409, 'Mahasiswa tidak dapat dihapus karena sudah memiliki data pengerjaan praktikum.'],
    ...
    JOBSHEET_PLAN_MIN_INVALID: [400, 'Jumlah jobsheet minimal 0.'],
