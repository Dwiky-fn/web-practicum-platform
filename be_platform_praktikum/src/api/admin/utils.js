...
function handleAdminError(error, res) {
  ...
  const errors = {
    ...
    KELAS_SEMESTER_TARGET_NOT_FOUND: [400, 'Kelas tujuan pada tahun semester target belum tersedia'],
    ...
    STUDENT_PROMOTION_ACTION_INVALID: [400, 'Kenaikan semester hanya mendukung aksi naik semester'],
    STUDENT_PROMOTION_TARGET_REQUIRED: [400, 'Semester dan kelas tujuan wajib dipilih'],
    STUDENT_SEMESTER_JUMP_NOT_ALLOWED: [400, 'Mahasiswa tidak dapat lompat semester tanpa penanda mahasiswa pindahan'],
    TRANSFER_REASON_REQUIRED: [400, 'Alasan mahasiswa pindahan wajib diisi saat melewati urutan semester'],
