                        ...
                        content: [
                          {
                            ...
                            content: [
                              {
                                type: 'paragraph',
                                content: [{ type: 'text', text: 'Tipe Data' }],
                              },
                            ],
                          },
                          {
        ...
        content: [
          ...
          },
          {
            ...
            content: [
              {
                type: 'text',
                text: 'access_modifier',
                marks: [{ type: 'code' }],
              },
              {
                type: 'text',
                text: ' dapat berupa default (tidak dituliskan secara eksplisit di dalam program), private, protected, public. ',
              },
              { type: 'text', text: 'static', marks: [{ type: 'code' }] },
              {
                type: 'text',
                text: ' menunjukkan bahwa variabel merupakan variabel class. ',
              },
              { type: 'text', text: 'tipe_data', marks: [{ type: 'code' }] },
              {
                type: 'text',
                text: ' adalah semua tipe data yang dikenal oleh Java. ',
              },
              {
                type: 'text',
                text: 'nama_variable',
              ...
              {
                type: 'text',
                text: ' adalah nama variabel yang sesuai dengan aturan penamaan identifier. Berikut ini beberapa contoh deklarasi variabel:',
              },
            ],
          },
          {
        ...
        content: [
          ...
          },
          {
            ...
            content: [
              ...
              {
                type: 'text',
                text: ' dapat berupa default (tidak dituliskan), private, protected, public. ',
              },
              { type: 'text', text: 'static', marks: [{ type: 'code' }] },
              {
                type: 'text',
                text: ' menunjukkan bahwa konstanta merupakan konstanta class. ',
              },
              { type: 'text', text: 'tipe_data', marks: [{ type: 'code' }] },
              {
                type: 'text',
              ...
              {
                type: 'text',
                text: ' adalah nama konstanta yang sesuai dengan aturan penamaan identifier. Berikut ini beberapa contoh deklarasi konstanta:',
              },
            ],
          },
          {
          ...
          },
          {
            ...
            content: [
              {
                type: 'text',
                text: 'final int NILAI, HARGA = 200;\nfinal char KARAKTER = \'a\';\nfinal String NAMA = "Andii";',
                marks: [{ type: 'code' }],
              },
            ],
          },
